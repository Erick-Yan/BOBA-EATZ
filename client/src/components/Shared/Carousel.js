...
const Carousel = props => {
    ...
    useEffect(() => {
        const fetchAwards = async () => {
          try {
            const drinkData = await sendRequest(`${process.env.PORT || process.env.REACT_APP_BACKEND}/api/drinks/awards`);
            ...
            const shopData = await sendRequest(`${process.env.PORT || process.env.REACT_APP_BACKEND}/api/shops/awards`);
